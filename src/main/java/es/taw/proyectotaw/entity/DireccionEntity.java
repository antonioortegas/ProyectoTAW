...
public class DireccionEntity {
    ...
    private Byte valida;
    @OneToMany(mappedBy = "direccionByDireccionCliente")
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(calle, that.calle) && Objects.equals(numero, that.numero) && Objects.equals(puerta, that.puerta) && Objects.equals(ciudad, that.ciudad) && Objects.equals(pais, that.pais) && Objects.equals(cp, that.cp) && Objects.equals(region, that.region) && Objects.equals(valida, that.valida);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, calle, numero, puerta, ciudad, pais, cp, region, valida);
    }
